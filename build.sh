...
../framework/tools/linux/abc2 logo.png -bpc 4 -uninterleaved -b logo_bpls.bin -p logo_pal.bin
...
../framework/tools/linux/abc2 bobs.png -bpc 2 -uninterleaved -b bobs_bpls.bin -p bobs_pal.bin
../framework/tools/linux/abc2 masks.png -bpc 1 -uninterleaved -b masks_bpls.bin
cd ..
